...
<?php
	...
	if(isset($_POST['submit']))
	{
		...
		{
	            header('Location: https://ec2-52-15-127-4.us-east-2.compute.amazonaws.com/HW10/request.php?fnameErr=err');
		}
		//$lname=$_REQUEST['lastName'];
                if (($lname=$_REQUEST['lastName'])=="")
                {
	            header('Location: https://ec2-52-15-127-4.us-east-2.compute.amazonaws.com/HW10/request.php?lnameErr=err');
                }
		if (($email=$_REQUEST['email'])=="")
                {
	            header('Location: https://ec2-52-15-127-4.us-east-2.compute.amazonaws.com/HW10/request.php?emailErr=err');
                }
