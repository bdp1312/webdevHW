...
?>
<script>
    funciton refresh_div()[
        $.ajax({
            type:'post'
                url: 'https://MYAWSURL/qeury.php'
                success: function(data){
                    //equivalent of document.getelementbyid() in javascript
                    $('#fdsults').html(data);
                    //outputs html and adds it to data table
                }
            }); 
        };
setInterval(function(){$refresh_div()
